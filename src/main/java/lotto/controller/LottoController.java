...
public class LottoController {
    ...
    public void run() {
        ...
        LottoResultCalculator resultCalculator = new LottoResultCalculator(winningNumbers, bonusNumber);
        Map<String, Integer> result = resultCalculator.calculate(lottos);
